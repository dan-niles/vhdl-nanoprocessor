...
HD_PWD='E:/Projects/Lab10/Lab10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Add_Sub_Unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Add_Sub_Unit.tcl -notrace
